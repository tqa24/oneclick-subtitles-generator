...
/**
 * Check if a blob URL is still valid (async)
 * @param {string} blobUrl - The blob URL to check
 * @returns {Promise<boolean>} True if the blob URL is still accessible
 */
export const isBlobUrlValid = async (blobUrl) => {
